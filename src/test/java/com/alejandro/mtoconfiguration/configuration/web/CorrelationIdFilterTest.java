...
class CorrelationIdFilterTest {
    ...
    void generatesAnIdentifierWhenTheRequestDoesNotBringOne() throws Exception {
        ...
        filter.doFilter(new MockHttpServletRequest("GET", "/api/v1/configuration/profiles"), response, (request, res) -> seenInMdc.set(MDC.get(CorrelationIdFilter.MDC_KEY)));
    ...
    void reusesAValidInboundIdentifier() throws Exception {
        MockHttpServletRequest request = new MockHttpServletRequest("GET", "/api/v1/configuration/profiles");
