...
@RequestScope
@Slf4j
public class SteadyArmValidator extends CRUDValidator<SteadyArmDTO> {

    @Override
    public List<Alert> validateBeforeDelete(SteadyArmDTO dto) {
        getAlerts().clear();
    ...
    @Override
    public List<Alert> validateBeforeSave(SteadyArmDTO dto) {
        return List.of();
    }
}
