...
@RequestScope
@Slf4j
public class ExecutionPackageValidator extends CRUDValidator<ExecutionPackageDTO> {


    @Override
    public List<Alert> validateBeforeDelete(ExecutionPackageDTO dto) {
        getAlerts().clear();
    ...
    @Override
    public List<Alert> validateBeforeSave(ExecutionPackageDTO dto) {
        return List.of();
    }
}
