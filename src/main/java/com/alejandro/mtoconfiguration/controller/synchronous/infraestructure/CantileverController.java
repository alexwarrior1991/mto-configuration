...
@RequestMapping(value = "/api/v1/cantilever")
@Tag(
        name = "Cantilevers",
...
public class CantileverController extends CRUDController<CantileverDTO, Cantilever> {
    ...
    public ResponseEntity<Object> create(@RequestBody CantileverDTO dto) {
    ...
    @ApiResponse(responseCode = ApiConstants.CODE_400, description = ApiConstants.DESC_400)
    public ResponseEntity<Object> bulkCreate(@RequestBody List<CantileverDTO> dtoList) {
    ...
    @ApiResponse(responseCode = ApiConstants.CODE_200, description = ApiConstants.DESC_200)
    @ApiResponse(responseCode = ApiConstants.CODE_400, description = ApiConstants.DESC_400)
    public ResponseEntity<Object> bulkUpdate(@RequestBody List<CantileverDTO> dtoList) {
