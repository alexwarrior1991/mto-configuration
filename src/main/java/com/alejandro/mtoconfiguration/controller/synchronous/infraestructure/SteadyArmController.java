...
@RequestMapping(value = "/api/v1/steady-arm")
@Tag(
        name = "Steady Arms",
...
public class SteadyArmController extends CRUDController<SteadyArmDTO, SteadyArm> {
    ...
    public ResponseEntity<Object> create(@RequestBody SteadyArmDTO dto) {
    ...
    @ApiResponse(responseCode = ApiConstants.CODE_400, description = ApiConstants.DESC_400)
    public ResponseEntity<Object> bulkCreate(@RequestBody List<SteadyArmDTO> dtoList) {
    ...
    @ApiResponse(responseCode = ApiConstants.CODE_200, description = ApiConstants.DESC_200)
    @ApiResponse(responseCode = ApiConstants.CODE_400, description = ApiConstants.DESC_400)
    public ResponseEntity<Object> bulkUpdate(@RequestBody List<SteadyArmDTO> dtoList) {
