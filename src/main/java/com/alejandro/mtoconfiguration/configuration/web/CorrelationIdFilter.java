package com.alejandro.mtoconfiguration.configuration.web;
 ...
 * puesto por el gateway, o por el backoffice que llama a través de él— o uno nuevo si falta o no es
 * válido. Se devuelve en la respuesta y se pone en el MDC para que salga en cada línea de log
 * ({@code logging.pattern.correlation}); la revisión de Envers lo lee aparte de la cabecera.
 *
 * <p>Copia del filtro de {@code mto-users}. Antes esta API no lo tenía y el identificador con el
 * que el gateway trazaba una llamada no aparecía en ningún log de aquí.</p>
 *
